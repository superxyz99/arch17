...
[task_local]
#动物研究院
10 9 * * * https://raw.githubusercontent.com/age174/-/main/dwyjy.js, tag=动物研究院, img-url=https://ae01.alicdn.com/kf/Udd9cb36174cf41a7a69e28a643a360a9a.jpg, enabled=true
...
const $ = new Env('动物研究院');
let status;
status = (status = ($.getval("dwyjystatus") || "5") ) > 1 ? `${status}` : ""; // 账号扩展字符
